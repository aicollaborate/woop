...
$runRoot = Join-Path ([System.IO.Path]::GetTempPath()) ('dsh-app-server-smoke-' + [Guid]::NewGuid().ToString('N'))
...
$frames = @(
  '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"provider":"deepseek-official","model":"deepseek-v4-flash","cwd":"D:/Notes/推广方案/dsh-app-server"}}',
